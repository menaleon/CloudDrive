...
void LZ78::insert_Node(LZ78::Node *head, int index, string data) {
...
LZ78::Node *LZ78::search_Node(LZ78::Node *head, int index) {
    Node *curr = head;
    while (curr != nullptr)
    {
        if (index == curr->index)
...
LZ78::Node *LZ78::search_Node(LZ78::Node *head, string data) {
    Node *curr = head;
    while (curr != nullptr)
    {
